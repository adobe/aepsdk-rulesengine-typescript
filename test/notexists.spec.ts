...
describe("matcher type - not exists (nx)", () => {
  ...
  it("returns consequence when key doesn't exists", async () => {
  ...
  it("returns empty consequence when key does exist", async () => {
    const result = await ruleset.execute({
      country: "USA",
      city: "Wendover",
      state: "NV",
  ...
  it("returns consequence when key does exist but key's value in the context is null", async () => {
    const result = await ruleset.execute({
      country: "USA",
      city: "Wendover",
      state: "NV",
  ...
  it("returns consequence when key does exist but key's value in the context is undefined", async () => {
    const result = await ruleset.execute({
      country: "USA",
      city: "Wendover",
      state: "NV",
